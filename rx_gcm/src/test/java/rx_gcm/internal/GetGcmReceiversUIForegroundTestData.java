...
public class GetGcmReceiversUIForegroundTestData {
    private GetGcmReceiversUIForeground getGcmReceiversUIForegroundUT;
    ...
    @Before public void setUp()  {
        ...
        getGcmReceiversUIForegroundUT = new GetGcmReceiversUIForeground();
        getGcmReceiversUIForegroundUT.mockForTestingPurposes();
    }
    ...
    @Test public void When_Several_GcmReceiverUIForeground_Return_One_Which_Is_Target_Screen() {
        ...
        wrapper = getGcmReceiversUIForegroundUT.retrieve(targetScreen, activityMockReceiver);
        assertThat(wrapper.isTargetScreen(), is(true));
    ...
    @Test public void When_No_One_GcmReceiverUIForeground_Return_Null_Wrapper() {
        ...
        GetGcmReceiversUIForeground.Wrapper wrapper = getGcmReceiversUIForegroundUT.retrieve("no one", activityMock);
        assertNull(wrapper);
    }
