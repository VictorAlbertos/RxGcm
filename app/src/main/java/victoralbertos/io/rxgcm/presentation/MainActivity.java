...
public class MainActivity extends AppCompatActivity implements GcmForegroundReceiver {
    ...
    @Override public void onReceiveMessage(Observable<ForegroundMessage> oMessage) {
        final TextView tv_title = (TextView) findViewById(R.id.tv_title_activity);
        final TextView tv_body = (TextView) findViewById(R.id.tv_body_activity);
    ...
    public void receivedFromCentralized(ForegroundMessage message) {
        final TextView tv_title = (TextView) findViewById(R.id.tv_title_centralized);
        final TextView tv_body = (TextView) findViewById(R.id.tv_body_centralized);
